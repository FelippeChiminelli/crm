...
export function ConnectWhatsAppModal({
  ...
  const isBusy = connecting || generatingPairingCode
  ...
  const startConnectionMonitoring = (instanceId: string) => {
    ...
    const interval = setInterval(() => {
      checkConnectionStatus(instanceId, sub, interval)
    }, 2000)
    ...
    try {
      ...
      if (result?.instance_id) {
        ...
        if (result.qr_code) {
          ...
          setConnectionStatus('connecting')
          startConnectionMonitoring(result.instance_id)
  ...
  const handleGeneratePairingCode = async () => {
    ...
    try {
      const result = await generateWhatsAppPairingCode(form)
        ...
        <div className="relative bg-white rounded-lg shadow-xl max-w-2xl w-full p-6">
          ...
          {pairingCode && connectionStatus !== 'connected' && (
            <div className="text-center">
              ...
              <p className="text-sm text-gray-600 mb-6">
                No WhatsApp, vá em Dispositivos conectados → Conectar com número de telefone e digite o código abaixo
              </p>
            ...
            <div className="space-y-4">
              ...
              <div className="flex flex-col sm:flex-row gap-3 pt-2">
                ...
                <button
                  ...
                  disabled={isBusy || !form.name.trim() || !form.phone_number.trim()}
